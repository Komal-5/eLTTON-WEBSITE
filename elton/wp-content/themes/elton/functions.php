...
function twentyseventeen_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Header Icons', 'twentyseventeen' ),
			'id'            => 'header-icons',
	...
	register_sidebar(
		array(
			'name'          => __( 'Connect Us Address', 'twentyseventeen' ),
			'id'            => 'connect-us-address',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '<h2 class="widget-title">',
	...
	register_sidebar(
		array(
			'name'          => __( 'Connect Us Phone', 'twentyseventeen' ),
			'id'            => 'connect-us-phone',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
	...
	register_sidebar(
		array(
			'name'          => __( 'Connect Us Email', 'twentyseventeen' ),
			'id'            => 'connect-us-email',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentyseventeen' ),
			'before_widget' => '',
			'after_widget'  => '',
